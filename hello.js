var canvas = document.getElementById("yourcanvas");
        ...
        var aspectRatio = 1;
        var width = 400;
        var height = 400 / aspectRatio;
        
        var actualWidth = Math.min(window.innerWidth, window.innerHeight * aspectRatio);
        ...
        canvas.style.transform = "scale(" + (actualWidth / width) + ")";
        ...
        PVector.mult = function(v, m) {
            return new PVector(v.x * m, v.y * m);
        };
        PVector.prototype.mult = function(m) {
            this.x *= m;
            this.y *= m;
        };
        ...
        PVector.prototype.div = function(num) {
            this.x /= num;
            this.y /= num;
        };
        ...
        PVector.normalize = function(vect) {
            return PVector.div(vect, vect.mag());
        };
        var handleKeyPress = function(e) {
            e.preventDefault();
            keyPressed(e);
        };
        var handleKeyRelease = function(e) {
            e.preventDefault();
            keyReleased(e);
        };
